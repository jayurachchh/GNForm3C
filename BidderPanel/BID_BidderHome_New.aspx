<%@ Page Title="Home" Language="C#" AutoEventWireup="true" CodeFile="BID_BidderHome_New.aspx.cs" Inherits="BidderPanel_BID_BidderHome_New" %>
        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <div class="trust-badges">
                    <div class="badge"><i class="fas fa-lock"></i>Secure & Compliant</div>
                    <div class="badge"><i class="fas fa-shield-alt"></i>99.9% Uptime</div>
                    <div class="badge"><i class="fas fa-users"></i>10K+ Bidders</div>
                </div>
            </div>
        ...
        <div class="premium-contact">
            <div class="contact-grid">
                ...
                <div class="contact-card">
                    ...
                    <h3>Email Support</h3>
                    <a href="mailto:admin@srmhub.com" class="contact-link">admissions@paruluniversity.ac.in
                    </a>
                ...
                <div class="contact-card">
                    ...
                    <h3>Phone Support</h3>
                    <a href="tel:+919558210145" class="contact-link">+91 95582 10145
                    </a>
                ...
                <div class="contact-card location-card">
                    ...
                    <div class="map-container">
                        <iframe
                            ...
                            allowfullscreen=""
                            loading="lazy"
                            referrerpolicy="no-referrer-when-click"></iframe>
                    </div>
                </div>
            </div>
        </div>
