...
public partial class AdminPanel_MasterDashboardFinyear : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        foreach (RepeaterItem rpAc in rpFinYear.Items)
        {
           ...
           // MST_DSB2BAL balMST_DSB2BAL = new MST_DSB2BAL();
            MST_DSB_FinYearBAL balMST_DSB2BAL = new MST_DSB_FinYearBAL();
...
/*    private void ShowChart()
    {
        ...
        // Make sure this script is injected correctly into the page
        ClientScript.RegisterStartupScript(this.GetType(), "chartScript", "drawChart('" + jsonData + "');", true);
    }*/


    //private DataTable GetChartData(SqlInt32 FinyearID)
    //{
    //    // Assuming this method fetches data correctly from the database
    //    MST_DSB_FinYearBAL balMST_DSB2 = new MST_DSB_FinYearBAL();
