<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MasterDashboardFinyear.aspx.cs" Inherits="AdminPanel_MasterDashboardFinyear" %>
                                                                        ...
                                                                        <div class="form-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                                    ...
                                                                                    <a class="dashboard-stat dashboard-stat-v2 blue" href='<%= "Account/ACC_Income/ACC_IncomeList.aspx?HospitalID"%>'>
                                                                                ...
                                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                                    <a class="dashboard-stat dashboard-stat-v2 red" href='<%= "Account/ACC_Expense/ACC_ExpenseList.aspx?HospitalID"%>'>
                                                                                        <div class="visual">
                                                                                ...
                                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                                    <a class="dashboard-stat dashboard-stat-v2 green" href='<%= "Master/MST_SubTreatment/MST_SubTreatmentList.aspx?HospitalID"%>'>
                                                                                        <div class="visual">
        ...
        function drawChart(containerId, chartData) {
            ...
            var options = {
                ...
                vAxis: {
                    ...
                    minValue: 0,
                    maxValue: 60000 // Match the scale with your example (up to 60,000)
                },
                legend: {
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphScripts" runat="Server">
    ...
    <script>
        ...
        function drawChart(containerId, chartData) {
            ...
            console.log(tickMarks.toString());
            ...
            console.log(ticksFormatted);

            var windowWidth = window.innerWidth * 0.80;
