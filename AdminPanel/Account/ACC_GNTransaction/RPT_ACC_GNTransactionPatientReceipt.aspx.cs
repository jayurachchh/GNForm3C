...
public partial class AdminPanel_Account_ACC_GNTransaction_RPT_ACC_GNTransactionPatientReceipt : System.Web.UI.Page
{
    ...
    private void ExportReport(string format)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=Patient Report." + extension);
    ...
    protected void ShowReport()
    {
        if (Request.QueryString["TransactionID"] != null && Request.QueryString["ReportType"] != null)
        {
            ...
            DataTable dtPatientReceipt = balACC_GNTransaction.PatientReceiptByTransactionID(TransactionID);
    ...
    protected void FillDataSet(DataTable dtPatientReceipt)
    {
        ...
        {
            GnTransaction.dt_Acc_TransactionRow drPatientReceipt = objdsgntransaction.dt_Acc_Transaction.Newdt_Acc_TransactionRow();
            ...
            objdsgntransaction.dt_Acc_Transaction.Rows.Add(drPatientReceipt);

        }

        SetReportParamater();
        this.rvpatientreceipt.LocalReport.DataSources.Clear();
        this.rvpatientreceipt.LocalReport.DataSources.Add(new ReportDataSource("dt_Acc_Transaction", (DataTable)objdsgntransaction.dt_Acc_Transaction));
