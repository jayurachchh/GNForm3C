                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <ajaxToolkit:AutoCompleteExtender
                                                ...
                                                ServicePath="~/AdminPanel/WebService/PatientName.asmx"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlPatient" CssClass="form-control select2me" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <%--	<div class="col-md-4">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th class="text-center">
                                                        <asp:Label ID="lbhDate" runat="server" Text="Date of patient"></asp:Label>
                                                    </th>
                                                    <th>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="lbhFinYearID" runat="server" Text="Finicial Year"></asp:Label>
                                                    </th>
                                                    <th>
                                                    ...
                                                    <th class="nosortsearch text-nowrap text-center">
                                                        <asp:Label ID="lbhExport" runat="server" Text="Export"></asp:Label>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <%-- END Table Header --%>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <asp:HyperLink
                                                                    ...
                                                                    ID="hlprint"
                                                                    SkinID="hlprint"
                                                                    NavigateUrl='<%# "~/AdminPanel/Account/ACC_GNTransaction/RPT_ACC_GNTransactionPatientReceipt.aspx?TransactionID=" +   GNForm3C.CommonFunctions.EncryptBase64(Eval("TransactionID").ToString()) + "&ReportType=" + GNForm3C.CommonFunctions.EncryptBase64("PDF") %>'></asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
                                                    </ItemTemplate>
