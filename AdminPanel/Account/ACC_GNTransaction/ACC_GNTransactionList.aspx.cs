...
public partial class AdminPanel_Account_ACC_GNTransaction_ACC_GNTransactionList : System.Web.UI.Page
{
    ...
    private DataTable objdtgntransaction = new DataTable();
    private GnTransaction objdsgntransaction = new GnTransaction();
    ...
    {
        CommonFillMethods.FillDropDownListPatientID(ddlPatient);
    ...
    private void Search(int PageNo)
    {
       ...
       SqlInt32 Patient = SqlInt32.Null;
        ...
        string selectpatient = selectedPatientID.Split('-')[0].Trim();
        ...
        if (Request.QueryString["HospitalID"] != null)
        {
            ...
            else
            {
             /*   if (ddlPatient.SelectedIndex > 0)
                    Patient = Convert.ToInt32(ddlPatient.SelectedValue);*/
                
                if (int.TryParse(selectpatient, out patientID) && txtACEPatientName.Text.Trim() != String.Empty)
                    Patient = patientID;
        ...
        DataTable dt = balACC_Transaction.SelectPage(Offset, PageRecordSize, out TotalRecords, Patient, Amount, ReferenceDoctor, Count, ReceiptNo, Date, DateOfAdmission, DateOfDischarge, Deposite, NetAmount, NoOfDays, HospitalID, FinYearID, ReceiptTypeID);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        // ACC_GNTransactionBAL balACC_Transaction = new ACC_TransactionBAL();
        ACC_GNTransactionBAL balACC_Transaction = new ACC_GNTransactionBAL();
        DataTable dtACC_Transaction = balACC_Transaction.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, Patient, Amount, ReferenceDoctor, Count, ReceiptNo, Date, DateOfAdmission, DateOfDischarge, Deposite, NetAmount, NoOfDays, HospitalID, FinYearID, ReceiptTypeID);
