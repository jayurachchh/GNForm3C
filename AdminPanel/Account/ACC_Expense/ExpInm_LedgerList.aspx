...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Ledger List"></asp:Label>
    <small>
...
<%--                               <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtType" CssClass="form-control" runat="server" PlaceHolder="Enter Type"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>--%>
                               ...
                               <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:DropDownList ID="ddlType" CssClass="form-control select2me" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <%--<div>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" runat="server"></asp:HyperLink>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lblLedgerdate" runat="server" Text="Date"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lblType" runat="server" Text="Type (Income/Expense)"></asp:Label>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        <%-- Table Rows --%>
                                                        <tr class="odd gradeX" style='<%# Eval("LedgerType").ToString() == "Income" ? " background-color: #73bba3; color: black;": "background-color: #ffaaaa; color: black;" %>'>
                                                            <%--                                                            <td>
