<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_ACC_Expense_Hospital_DateWise.aspx.cs" Inherits="AdminPanel_Account_ACC_Expense_RPT_ACC_Expense_Hospital_DateWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    <asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Hospital DateWise Expense"></asp:Label>
    <small>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphPageContent" runat="Server">
    ...
    <rsweb:ReportViewer ID="rvExpenseReport" runat="server" Width="100%" Height="100%" Visible="false">
        <LocalReport ReportPath="AdminPanel\Report\RPT_ACC_Expense\RPT_Hospital_DateWise_Expense.rdlc"></LocalReport>
    </rsweb:ReportViewer>
