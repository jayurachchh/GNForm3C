<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="CFG_ReportSettingList.aspx.cs" Inherits="AdminPanel_CFG_ReportSetting_CFG_ReportSettingList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
	<asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Report Setting"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="ReportSetting"></asp:Label>
    </li>
</asp:Content>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtReportHeaderFontType" CssClass="First form-control" runat="server"  PlaceHolder="Enter Report Header Font Type"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtReportHeaderFontSize" CssClass="form-control" runat="server"  PlaceHolder="Enter Report Header Font Size"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtTableHeaderFontSize" CssClass="form-control" runat="server"  PlaceHolder="Enter Table Header Font Size"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtTableRowFontSize" CssClass="form-control" runat="server"  PlaceHolder="Enter Table Row Font Size"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtFooterFontSize" CssClass="form-control" runat="server"  PlaceHolder="Enter Footer Font Size"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                 <div>
									<asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Config/CFG_ReportSetting/CFG_ReportSettingAddEdit.aspx" runat="server"></asp:HyperLink>
                        ...
                        <div class="portlet-body">
                            <div class="row" runat="server" id="Div_SearchResult" visible="false">
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th><asp:Label ID="lbhReportHeaderFontType" runat="server" Text="Report Header Font Type"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhReportHeaderFontSize" runat="server" Text="Report Header Font Size"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhReportHeaderFontStyle" runat="server" Text="Report Header Font Style"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhTableHeaderFontType" runat="server" Text="Table Header Font Type"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhTableHeaderFontSize" runat="server" Text="Table Header Font Size"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhTableHeaderFontStyle" runat="server" Text="Table Header Font Style"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhTableRowFontType" runat="server" Text="Table Row Font Type"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhTableRowFontSize" runat="server" Text="Table Row Font Size"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhTableRowFontStyle" runat="server" Text="Table Row Font Style"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhFooterFontType" runat="server" Text="Footer Font Type"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhFooterFontSize" runat="server" Text="Footer Font Size"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhFooterFontStyle" runat="server" Text="Footer Font Style"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhIsPrintDate" runat="server" Text="Is Print Date"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhIsPrintDateWithTime" runat="server" Text="Is Print Date With Time"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhIsPrintUserName" runat="server" Text="Is Print User Name"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                            <asp:HyperLink ID="hlViewReportSettingID" NavigateUrl='<%# "~/AdminPanel/Config/CFG_ReportSetting/CFG_ReportSettingView.aspx?ReportSettingID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ReportSettingID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("ReportHeaderFontType") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("ReportHeaderFontSize") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("ReportHeaderFontStyle") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("TableHeaderFontType") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("TableHeaderFontSize") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("TableHeaderFontStyle") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("TableRowFontType") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("TableRowFontSize") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("TableRowFontStyle") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("FooterFontType") %>
                                                            </td>
                                                            ...
                                                            <td>
                                                            	<%#Eval("FooterFontStyle") %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("IsPrintDate", GNForm3C.CV.DefaultDateFormatForGrid) %>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("IsPrintDateWithTime") %>
                                                            </td>
                                                            <td>
								...
								<asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Config/CFG_ReportSetting/CFG_ReportSettingAddEdit.aspx?ReportSettingID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ReportSettingID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                    SkinID="Delete"
                                                                    OnClientClick="javascript:return confirm('Are you sure you want to delete record ? ');"
                                                                    CommandName="DeleteRecord"
                                                                    CommandArgument='<%#Eval("ReportSettingID") %>'>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
