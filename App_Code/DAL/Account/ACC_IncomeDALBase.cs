...
{
    public  class ACC_IncomeDALBase : DataBaseConfig
    {
        #region Properties
        ...
        public Boolean DeleteMultiple(string ledgerIdsList)
        {
            ...
            {
                SqlDatabase sqlDB = new SqlDatabase(myConnectionString);
                DbCommand dbCMD = sqlDB.GetStoredProcCommand("Pro_DeleteIncome_Multiple_Income");

                // Add the comma-separated list as an input parameter
                sqlDB.AddInParameter(dbCMD, "@ACC_IncomeTableIDsList", SqlDbType.NVarChar, ledgerIdsList);
        ...
        public DataTable SelectShow(SqlInt32 FinYearID, SqlInt32 HospitalID, SqlInt32 IncomeTypeID)
        {
            ...
            try
            {
                ...
                DataTable dtACC_Income_Show = new DataTable("PR_ACC_IncomeType_SelectShow");
