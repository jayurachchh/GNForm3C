...
namespace GNForm3C.DAL
{
	public abstract class MST_ReceiptTypeDALBase : DataBaseConfig
	{
        ...
        public DataTable SelectPage(SqlInt32 PageOffset, SqlInt32 PageSize, out Int32 TotalRecords, SqlString ReceiptTypeName, SqlString PrintName, SqlInt32 HospitalID, SqlInt32 IsDefault)
		{
			TotalRecords = 0;
			try
			{
                ...
                sqlDB.AddInParameter(dbCMD, "@IsDefault", SqlDbType.Int, IsDefault);
