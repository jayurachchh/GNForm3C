...
namespace GNForm3C.DAL
{
	public abstract class MST_ExpenseTypeDALBase : DataBaseConfig
	{
        ...
        public DataTable SelectComboBoxExpenseTypeHospital()
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(myConnectionString);
                DbCommand dbCMD = sqlDB.GetStoredProcCommand("PR_MST_ExpenseTypeHospital_SelectComboBox");

                DataTable dtMST_ExpenseType = new DataTable("PR_MST_ExpenseTypeHospital_SelectComboBox");
